...
def create_first_block
  ...
  instance_variable_set("@b#{i}",
                        Block.first(
                          { from: 'Dutchgrown', to: 'Vincent', what: 'Tulip Bloemendaal Sunset',
                            qty: 10 },
...
def create_second_block
  ...
  instance_variable_set("@b#{i}",
                        Block.first(
                          ...
                          { from: 'Irving', to: 'Wade', what: 'NBA t-shirts', qty: 6 },
                          { from: 'Durant', to: 'Doncic', what: 'NBA merchandising',	qty: 8 }
                        ))
  LEDGER << @b1
  pp @b1
  p '============================'
...
def create_third_block
  i = 2
  instance_variable_set("@b#{i}",
                        Block.first(
                          { from: 'Ronaldo', to: 'Messi', what: 'Golden Ball', qty: 9 }
                        ))
  LEDGER << @b2
  pp @b2
  p '============================'
...
def launcher2
  puts '==========================='
  puts 'Wait for the second auto-generated block of the blockchain'
  puts ''
  for i in 1..10
    print '.'
    sleep 0.25
...
def launcher3
  puts '==========================='
  puts 'Wait for the third auto-generated block of the blockchain'
  puts ''
  for i in 1..10
    print '.'
    sleep 0.25
